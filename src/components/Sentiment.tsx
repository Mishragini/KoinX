...
export function Sentiment(){
    ...
    return(
        <div className="bg-white mx-3 p-4 mt-2 rounded-md">
           ...
           <div className="flex items-center mt-4 ">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="grey" className="w-6 text-slate-500 h-6">
             <path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12Zm8.706-1.442c1.146-.573 2.437.463 2.126 1.706l-.709 2.836.042-.02a.75.75 0 0 1 .67 1.34l-.04.022c-1.147.573-2.438-.463-2.127-1.706l.71-2.836-.042.02a.75.75 0 1 1-.671-1.34l.041-.022ZM12 9a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z" clipRule="evenodd" />
           </svg>
            </div>
           <div className='flex items-center mt-4'>
          
           <div className='rounded-full bg-green-200 p-4 w-40 h-40 flex items-center justify-center mr-6 text-slate-500'>
               <div className='text-green-600 text-3xl'>76%</div>
            </div>
            <div>
                <div className='flex items-center'>
                <div className='mx-6 text-slate-500'>Buy</div>
                <hr className="w-96 h-2   bg-green-700 border-0 rounded md:my-10"></hr>
                <div className='text-slate-500 ml-2'>76%</div>

                </div>
                <div className='flex items-center'>
                <div className='mx-6 text-slate-500'>Hold</div>
                <hr className="w-12 h-2  bg-slate-700 border-0 rounded md:my-10"></hr>
                <div className='text-slate-500 ml-2'>8%</div>

                </div >
                <div className='flex items-center'>
                <div className='mx-6 text-slate-500'>Sell</div>
                <hr className="w-24 h-2 bg-red-700 border-0 rounded md:my-10"></hr>
